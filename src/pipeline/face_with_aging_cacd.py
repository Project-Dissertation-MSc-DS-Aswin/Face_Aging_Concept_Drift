...
if __name__ == "__main__":
    ...
    # Apply the PCA on image covariates
    ...
    print(pca)
    # experiment set for dataset and experiment dataset
    ...
    # get the eigen vectors for Pandas
    ...
    # find the index based on age
    index = experiment.dataset.metadata['age'].reset_index()

    # collect the images from experiment dataset
    ...
    if args.log_images == 's3':
        ...
        # get the hash_samples by DISTINCT or DISTRIBUTION
    ...
    # set the predictions of drift to an array
    ...
    # get the dataframe of drift predictions
